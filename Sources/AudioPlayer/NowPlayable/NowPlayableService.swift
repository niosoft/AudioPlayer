...
extension NowPlayableService {
    // Customization point: register commands and provide a handler for registered
    // commands.
    public func handleNowPlayableConfiguration(commandHandler: @escaping (NowPlayableCommand, MPRemoteCommandEvent) -> MPRemoteCommandHandlerStatus) throws {
    ...
    public func handleNowPlayablePlaybackChange(isPlaying: Bool) {
#if os(macOS)
        MPNowPlayingInfoCenter.default().playbackState = isPlaying ? .playing : .paused
#endif
    }

    public func handleNowPlayablePlaybackChange(isPlaying: Bool, metadata: NowPlayableDynamicMetadata) {
    ...
    public func configureRemoteCommands(_ commands: [NowPlayableCommand],
